...
function rdtItems(
  ...
  const items: ExpandedDrop[] = [
    { name: "Coins", quantity: 3000, rarity: formatRarity((r * 21) / 128) },
    {
      name: "Uncut sapphire",
      quantity: 1,
      rarity: formatRarity((((r * 20) / 128) * 32) / 128 + (g * 32) / 128),
    },
    {
      name: "Loop half of key",
      quantity: 1,
      rarity: formatRarity((r * 20) / 128 + (((r * 20) / 128) * 1) / 128 + (g * 1) / 128),
    },
    {
    ...
    },
    {
      name: "Uncut emerald",
      quantity: 1,
      rarity: formatRarity((((r * 20) / 128) * 16) / 128 + (g * 16) / 128),
    },
    {
      name: "Uncut ruby",
      quantity: 1,
      rarity: formatRarity((((r * 20) / 128) * 8) / 128 + (g * 8) / 128),
    },
    ...
    { name: "Silver ore", quantity: "100 (noted)", rarity: formatRarity((r * 2) / 128) },
    {
      name: "Uncut diamond",
      quantity: 1,
      rarity: formatRarity((((r * 20) / 128) * 2) / 128 + (g * 2) / 128),
    },
    ...
    },
    {
      name: "Rune javelin",
      quantity: 5,
      rarity: formatRarity((((r * 20) / 128) * 1) / 128 + (g * 1) / 128),
    },
    {
      name: "Shield left half",
      quantity: 1,
      rarity: formatRarity(
        (((((r * 20) / 128) * 1) / 128) * 4) / 128 +
          (((r * 15) / 128) * 4) / 128 +
          (((g * 1) / 128) * 4) / 128,
      ),
    },
...
function gdtItems(rate: number, chaosTalisman: boolean, natureTalisman: boolean): ExpandedDrop[] {
  const items: ExpandedDrop[] = [
...
export function expandDropTables(dropTables: DropTable[], herbQuantity?: string): ExpandedDrop[] {
