...
export class ItemsExtractor {
  ...
  private async extractItemFromPageId(pageId: number): Promise<Item[] | null> {
    ...
    if (page.text!.includes('==Combat stats==')) {
      ...
      equipmentStats = {
        attackStab: Number(combatInfoBox.astab) || 0,
        attackSlash: Number(combatInfoBox.aslash) || 0,
        attackCrush: Number(combatInfoBox.acrush) || 0,
        attackMagic: Number(combatInfoBox.amagic) || 0,
        attackRanged: Number(combatInfoBox.arange) || 0,
        defendStab: Number(combatInfoBox.dstab) || 0,
        defendSlash: Number(combatInfoBox.dslash) || 0,
        defendCrush: Number(combatInfoBox.dcrush) || 0,
        defendMagic: Number(combatInfoBox.dmagic) || 0,
        defendRanged: Number(combatInfoBox.drange) || 0,
        strength: Number(combatInfoBox.str) || 0,
        rangedStrength: Number(combatInfoBox.rstr) || 0,
        magicDamage: Number(combatInfoBox.mdmg) || 0,
        prayer: Number(combatInfoBox.prayer) || 0,
        slot: combatInfoBox.slot ?? '',
        speed: Number(combatInfoBox.speed) || 0,
        attackRange: Number(combatInfoBox.attackrange) || 0,
