...
p.UNLOCK_WINGS_SPREAD = 12
p.UNLOCK_LURED_IN = 13
p.UNLOCK_CHANCE_OF_HEAVY_FROST = 14
...
p.QUEST_SHADOWS_OF_CUSTODIA = 27
p.QUEST_TROUBLED_TORTUGANS = 28
p.QUEST_THE_BLOOD_MOON_RISES = 29
...
-- 🦀 CRAB ADDED 🦀
p.TASK_CRABS = 154
p.TASK_CUSTODIAS = 155
p.TASK_METAL_DRAGONS = 156

--⛵Sailing yay⛵
p.TASK_GRYPHONS = 157
p.TASK_AQUANITES = 158
p.TASK_FROST_DRAGONS = 159

p.TASK_BOSS_MAGGOT_KING = 160

p.TASK_BOSS_SHELLBANE_GRYPHON = 161

-- Mortimer assigns Venators not Vampyres
p.TASK_VENATORS = 162
...
UNLOCK_IDS = {
	...
	["Wings Spread"] = p.UNLOCK_WINGS_SPREAD,
    ["Lured In"] = p.UNLOCK_LURED_IN,
    ["Chance of Heavy Frost"] = p.UNLOCK_CHANCE_OF_HEAVY_FROST
}
...
QUEST_IDS = {
	...
	["Shadows of Custodia"] = p.QUEST_SHADOWS_OF_CUSTODIA,
	["Pandemonium"] = p.QUEST_PANDEMONIUM,
	["Troubled Tortugans"] = p.QUEST_TROUBLED_TORTUGANS,
	["The Blood Moon Rises"] = p.QUEST_THE_BLOOD_MOON_RISES,
}
...
MONSTER_IDS = {
	...
	["Custodian stalker"] = p.TASK_CUSTODIAS,
	...
	["Metal dragons"] = p.TASK_METAL_DRAGONS,
	...
	["Shellbane gryphon"] = p.TASK_BOSS_SHELLBANE_GRYPHON,
	...
	["Crabs"] = p.TASK_CRABS,
    ["Gryphons"] = p.TASK_GRYPHONS,
    ["Aquanites"] = p.TASK_AQUANITES,
    ["Frost dragons"] = p.TASK_FROST_DRAGONS,
    ["Maggot King"] = p.TASK_BOSS_MAGGOT_KING,
    ["Venators"] = p.TASK_VENATORS
}
