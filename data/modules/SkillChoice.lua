--Quests are organised by least to most cumulative experience; quests with the same experience rewards are organised alphabetically (as they appear in the in-game quest list)--
...
local questList = {
	...
	},
	{
		...
		requirements = string.format('%s, %s, %s, %s, %s, %s, %s, %s, %s, %s', SCP('Slayer', '74'), SCP('Woodcutting', '74'), SCP('Smithing', '72'), SCP('Cooking', '72'), SCP('Fletching', '70'), SCP('Mining', '66'), SCP('Hunter', '65'), SCP('Crafting', '64'), SCP('Herblore', '64'), SCP('Magic', '57')),
		rewards = { 30000, 6 },
		restrictions = 70
	},
	{
