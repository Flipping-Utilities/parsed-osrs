...
local tabOverrides = {
	...
	["Shades of Mort'ton"] = "[[Shades of Mort'ton (minigame)|Shades of Mort'ton]]",
...
local clueTabs = { "Beginner Treasure Trails", "Easy Treasure Trails", "Medium Treasure Trails", "Hard Treasure Trails", "Hard Treasure Trails (Rare)", "Elite Treasure Trails", "Master Treasure Trails", "Elite Treasure Trails (Rare)", "Master Treasure Trails (Rare)", "Shared Treasure Trail Rewards" }
...
function p.list(frame)
	...
	return mw.text.jsonEncode(data, mw.text.JSON_PRESERVE_KEYS)
end
