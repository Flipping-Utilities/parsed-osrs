...
-- rewardsTemplatePageName is a full page name to make it easier to find this usage in the future!
local fishTables = {
	{level=81, levelRangeName="81+", rewardsTemplatePageName="Reward pool/Rewards levels 81+"},
	{level=79, levelRangeName="79-80", rewardsTemplatePageName="Reward pool/Rewards levels 79-80"},
	{level=76, levelRangeName="76-78", rewardsTemplatePageName="Reward pool/Rewards levels 76-78"},
	{level=50, levelRangeName="50-75", rewardsTemplatePageName="Reward pool/Rewards levels 50-75"},
	{level=46, levelRangeName="46-49", rewardsTemplatePageName="Reward pool/Rewards levels 46-49"},
	{level=40, levelRangeName="40-45", rewardsTemplatePageName="Reward pool/Rewards levels 40-45"},
	{level=35, levelRangeName="35-39", rewardsTemplatePageName="Reward pool/Rewards levels 35-39"},
}
...
function p.uniqueTable(frame, hasFishBarrel, hasTackleBox, hasBigHarpoon)
	local tinyTemporRarityNotes = frame:preprocess("{{CiteTwitter|author=Mod Zuko|url=https://twitter.com/JagexZuko/status/1392118795834122241|date=11 May 2021|archiveurl=https://reldo.runescape.wiki/i/102979|archivedate=11 May 2021|quote=|name=rewardPool}}")
...
function p.fishTable(frame, fishingLevel)
	for _, fishTable in ipairs(fishTables) do
		if fishingLevel >= fishTable.level then
			return frame:preprocess("These drops are for players with base Fishing level " .. fishTable.levelRangeName .. ".\n" .. "{{" .. fishTable.rewardsTemplatePageName .. "}}")
		end
	end
