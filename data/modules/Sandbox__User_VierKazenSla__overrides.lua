return {
    ...
    [32388] = { name = "Medallion fragment (1)", text = "[[Medallion fragment#1|Medallion fragment]]" },
    [32389] = { name = "Medallion fragment (2)", text = "[[Medallion fragment#2|Medallion fragment]]" },
    [32390] = { name = "Medallion fragment (3)", text = "[[Medallion fragment#3|Medallion fragment]]" },
    [32391] = { name = "Medallion fragment (4)", text = "[[Medallion fragment#4|Medallion fragment]]" },
    [32392] = { name = "Medallion fragment (5)", text = "[[Medallion fragment#5|Medallion fragment]]" },
    [32393] = { name = "Medallion fragment (6)", text = "[[Medallion fragment#6|Medallion fragment]]" },
    [32394] = { name = "Medallion fragment (7)", text = "[[Medallion fragment#7|Medallion fragment]]" },
    [32395] = { name = "Medallion fragment (8)", text = "[[Medallion fragment#8|Medallion fragment]]" }
}