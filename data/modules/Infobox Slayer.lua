...
function p.main(frame)
	...
	ret:defineParams{
		...
		{ name = 'mortimer', func = 'has_content' },
	...
	:addRow{
		{ tag = 'th', content = 'Task amounts (extended)', colspan = '30', class = 'infobox-subheader' }
	}
	...
	if ret:paramDefined('mortimer') then
		ret:addRow{
			{ tag = 'th', content = '[[File:Mortimer chathead.png|x30px|link=Mortimer]] [[Mortimer]]', colspan = '10' },
			{ tag = 'argd', content = 'mortimer', colspan = '20' }
		}
	end
