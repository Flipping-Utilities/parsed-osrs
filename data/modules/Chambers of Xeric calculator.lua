...
local regCoxItemWeights = {
	{name = "Arcane prayer scroll", weight = 14},
	{name = "Dexterous prayer scroll", weight = 14},
	{name = "Dragon hunter crossbow", weight = 4},
	{name = "Twisted buckler", weight = 4},
	{name = "Dinh's bulwark", weight = 3},
	{name = "Ancestral hat", weight = 4},
	{name = "Ancestral robe bottom", weight = 4},
	{name = "Ancestral robe top", weight = 4},
...
local cmItemWeights = {
	{name = "Arcane prayer scroll", weight = 12},
	{name = "Dexterous prayer scroll", weight = 12},
	{name = "Dragon hunter crossbow", weight = 4},
	{name = "Twisted buckler", weight = 4},
	{name = "Dinh's bulwark", weight = 3},
	{name = "Ancestral hat", weight = 4},
...
local trashItems = {
	{name = "Death rune", divisor = 36, weight = 3},
	{name = "Blood rune", divisor = 32, weight = 3},
	{name = "Soul rune", divisor = 20, weight = 3},
	{name = "Rune arrow", divisor = 14, weight = 3},
	{name = "Dragon arrow", divisor = 202, weight = 3},
	
	{name = "Grimy ranarr weed", divisor = 946, weight = 2},
	{name = "Grimy toadflax", divisor = 624, weight = 2},
	{name = "Grimy irit leaf", divisor = 194, weight = 2},
	{name = "Grimy avantoe", divisor = 389, weight = 2},
	{name = "Grimy kwuarm", divisor = 454, weight = 2},
	{name = "Grimy snapdragon", divisor = 1560, weight = 2},
	{name = "Grimy cadantine", divisor = 396, weight = 2},
	{name = "Grimy lantadyme", divisor = 297, weight = 2},
	{name = "Grimy dwarf weed", divisor = 240, weight = 2},
	{name = "Grimy torstol", divisor = 972, weight = 2},
	
	{name = "Ranarr seed", divisor = 6622, weight = 1},
	{name = "Toadflax seed", divisor = 4992, weight = 1},
	{name = "Irit seed", divisor = 1552, weight = 1},
	{name = "Avantoe seed", divisor = 3112, weight = 1},
	{name = "Kwuarm seed", divisor = 3632, weight = 1},
	{name = "Snapdragon seed", divisor = 10920, weight = 1},
	{name = "Cadantine seed", divisor = 3168, weight = 1},
	{name = "Lantadyme seed", divisor = 2376, weight = 1},
	{name = "Dwarf weed seed", divisor = 1920, weight = 1},
	{name = "Torstol seed", divisor = 6804, weight = 1},
	
	{name = "Silver ore", divisor = 20, weight = 3},
	{name = "Coal", divisor = 20, weight = 3},
	{name = "Gold ore", divisor = 44, weight = 3},
	{name = "Mithril ore", divisor = 32, weight = 3},
	{name = "Adamantite ore", divisor = 166, weight = 3},
	{name = "Runite ore", divisor = 2000, weight = 3},
	{name = "Uncut sapphire", divisor = 188, weight = 3},
	{name = "Uncut emerald", divisor = 142, weight = 3},
	{name = "Uncut ruby", divisor = 242, weight = 3},
	{name = "Uncut diamond", divisor = 508, weight = 3},
	
	{name = "Lizardman fang", divisor = 28, weight = 3},
	{name = "Pure essence", divisor = 2, weight = 3},
	{name = "Saltpetre", divisor = 28, weight = 3},
	{name = "Teak plank", divisor = 96, weight = 3},
	{name = "Mahogany plank", divisor = 238, weight = 3},
	{name = "Dynamite", divisor = 54, weight = 3},
	{name = "Torn prayer scroll", divisor = 1, weight = 3},
	{name = "Dark relic", divisor = 1, weight = 3}
}
...
function p.main(frame)
	...
	local weights = regCoxItemWeights
	local totalWeight = 60
	if args.challengeMode == 'yes' then
		weights = cmItemWeights
		totalWeight = 56
	end
	
	for _, unique in ipairs(weights) do
		local price = geprice(unique.name)
		
		local expectation = expectedRolls * unique.weight / totalWeight
		...
		uniquesTable:tag('tr')
			...
			:done()	
			:tag('td')
				:wikitext(string.format('1/%.2f', (personalRatio * expectation) ^ -1))
			:done()
			:tag('td')
	...
	for _, trash in ipairs(trashItems) do
		...
		local expectedCount = (1 - args.personalPoints / args.groupPoints * expectedRolls) * 2 * quantity * trash.weight / 99
