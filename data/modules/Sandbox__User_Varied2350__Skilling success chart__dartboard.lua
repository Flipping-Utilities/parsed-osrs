...
local chance_data = {
	dartboard = {
		_order={1,2,3},
		[1] = {75,240,'yellow', 'Sweetcorn seed 1.png'},
		[2] = {50,240, 'blue', 'Dwellberry seed 2.png'},
		[3] = {15,160, 'green', 'Jangerberry seed 3.png'}
	},
	archery = {
		_order = {1,2,3,5,10},
		[1] = {150,240, 'yellow', 'Sweetcorn seed 1.png'},
		[2] = {75,240, 'darkgrey', 'Papaya tree seed 2.png'},
		[3] = {50,240, 'purple', 'Cadavaberry seed 3.png'},
		[5] = {15,160, 'blue', 'Dwellberry seed 5.png'},
		[10] = {8,120,'green', 'Jangerberry seed 5.png'}
	}
}
local max_level = 99
...
function p.main(frame)
	...
	for i=0,#chances._order do
		...
		if i == 0 then
			ch_num = 0
			ch_val = {[3]='red',[4]='Dragonfruit tree seed 1.png'}
		else
