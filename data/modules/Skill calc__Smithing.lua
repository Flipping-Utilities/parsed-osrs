return {
    {
        name = 'Bronze bar',
        title = 'Bronze bar (smelting & smithing)',
        level = 1,
        xp = 18.7,
        materials = {
        ...
        members = 'No',
        type = 'Smelting & Smithing',
        outputCost = 0
    }, {
        name = 'Iron bar',
        title = 'Iron bar (smelting & smithing)',
        level = 15,
        xp = 37.5,
        materials = {
        ...
        name = 'Steel bar',
        title = 'Steel bar (smelting & smithing)',
        level = 30,
        xp = 55,
        materials = {
        ...
        name = 'Mithril bar',
        title = 'Mithril bar (smelting & smithing)',
        level = 50,
        xp = 80,
        materials = {
        ...
        name = 'Adamantite bar',
        title = 'Adamantite bar (smelting & smithing)',
        level = 70,
        xp = 100,
        materials = {
            { name = 'Adamantite ore', quantity = 1 },
            { name = 'Coal', quantity = 6 }
        },
        members = 'No',
        type = 'Smelting & Smithing',
        outputCost = 0
        ...
        name = 'Runite bar',
        title = 'Runite bar (smelting & smithing)',
        level = 85,
        xp = 125,
        materials = {
            { name = 'Runite ore', quantity = 1 },
            { name = 'Coal', quantity = 8 }
        },
        members = 'No',
        type = 'Smelting & Smithing',
        outputCost = 0
	...
	{   
    	...
    	name = 'Iron bar',
    	title = 'Iron bar (ring of forging)',
        level = 15,
        xp = 12.5,
        materials = {
        	{ name = 'Iron ore', quantity = 1 },
        	{ name = 'Ring of forging', quantity = 1/140 }
        },
        members = 'No',
        type = 'Smelting'
    }, {   
    	name = 'Iron bar',
    	title = 'Iron bar (Blast Furnace)',
        level = 15,
        xp = 12.5,
        materials = {
        	{ name = 'Iron ore', quantity = 1 }
    	...
    	name = 'Mithril bar',
    	title = 'Mithril bar (Blast Furnace)',
        level = 50,
        xp = 30,
        materials = {
        	{ name = 'Mithril ore', quantity = 1 },
    	...
    	name = 'Adamantite bar',
    	title = 'Adamantite bar (Blast Furnace)',
        level = 70,
        xp = 37.5,
        materials = {
        	{ name = 'Adamantite ore', quantity = 1 },
    	...
    	name = 'Runite bar',
    	title = 'Runite bar (Blast Furnace)',
        level = 85,
        xp = 50,
        materials = {
        	{ name = 'Runite ore', quantity = 1 },
	    ...
	    xp = 187.5,
	    materials = {
	        { name = 'Adamantite bar', quantity = 3 }
	    },
	    members = 'No',
	    type = 'Adamantite'
	}, {   
	    ...
	    xp = 312.5,
	    materials = {
	        { name = 'Adamantite bar', quantity = 5 }
	    },
	    members = 'No',
	    type = 'Adamantite'
	}, {   
	    ...
	    xp = 2000,
	    materials = {
	        { name = 'Draconic visage', quantity = 1 },
	        { name = 'Anti-dragon shield', quantity = 1 }
	    },
	    members = 'Yes',
	    type = 'Other'
	}
